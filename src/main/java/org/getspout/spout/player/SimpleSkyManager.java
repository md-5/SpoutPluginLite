...
public class SimpleSkyManager implements SkyManager {
    ...
    private final Map<String, Integer> cloudHeight = new HashMap<String, Integer>();
    private final Map<String, Integer> starFrequency = new HashMap<String, Integer>();
    private final Map<String, Integer> sunPercent = new HashMap<String, Integer>();
    private final Map<String, Integer> moonPercent = new HashMap<String, Integer>();
    private final Map<String, String> sunUrl = new HashMap<String, String>();
    private final Map<String, String> moonUrl = new HashMap<String, String>();
    private final Map<String, Color> skyColor = new HashMap<String, Color>();
    private final Map<String, Color> fogColor = new HashMap<String, Color>();
    private final Map<String, Color> cloudColor = new HashMap<String, Color>();
